...
def hola(message):
    last_word = message.text.split()[-1]  # Corrected to use message.text.split()
    ...
    if last_word.isdigit():
        ...
        if message.text.lower() in ["hola", "hello", "hi"]:  # Fixed condition syntax
            bot.send_message(
                message.chat.id,
